...
is_paused = False  # For button-triggered indefinite pause
is_temp_paused = False  # For sign-triggered temporary pause
        ...
        try:
            ...
            if current_accuracy > confidence_threshold:
                ...
                if current_prediction != last_prediction:
                    if current_prediction in ["SPACE", "BACKSPACE", "PAUSE"]:
                        execute_command(current_prediction, is_gesture=True)
                    elif not is_temp_paused and current_prediction != "ENTER":
